...
class User(db.Model):
    ...
    level = db.Column(db.String(50), default='Aprendiz do Café')
    total_spent = db.Column(db.Numeric(10, 2), default=0.00)
    account_type = db.Column(db.String(50), default='Pessoal')
...
class Payment(db.Model):
    ...
    # Dados do gateway
    gateway_response = db.Column(db.Text)  # JSON com resposta do gateway
...
# from src.models.stock import StockMovement, StockAlert, ProductBatch, InventoryCount, StockLocation, MovementType
